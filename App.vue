  ...
  >
    ...
    <div class="windows">
      <div
        ...
        v-on:mousedown="windowMouseDown(idx)"
      >
        <div class="controls">
        ...
        <div class="content">
          <p>
            ...
            nec ultrices mauris, ac consequat ligula. Etiam ut enim et est
            cursus pulvinar sed eu justo. Integer fermentum, magna ac volutpat
            elementum, ligula sem mollis erat, eget scelerisque nibh quam
            euismod est. Suspendisse et mauris convallis, dapibus eros ut,
            ornare nisi. Aenean quis varius ligula. Aenean ullamcorper fringilla
            mauris, at rhoncus nisl dictum fermentum. Nam sapien felis,
            ultricies at dui non, malesuada commodo massa. Donec volutpat
            consectetur libero non pellentesque. Fusce consectetur enim eget leo
            semper rutrum. Maecenas fermentum facilisis augue quis varius.
            Maecenas id nunc vel massa finibus blandit eget vel magna. Praesent
            eu lobortis purus. In non turpis est.
          </p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent
            nec ultrices mauris, ac consequat ligula. Etiam ut enim et est
...
<script>
  ...
  const ArticleComponent = new Vue({
  ...
  export default {
    ...
    computed: {},
    mounted() {
      this.createWindow("Vue Explorer", 20, 20);
      this.createWindow("Vue Explorer", 40, 40);
    },
    methods: {
      /**
      ...
      */
      mouseup() {
        console.log(this.activeWindow.offset.top);
